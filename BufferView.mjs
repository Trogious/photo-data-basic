...
export class BufferView {
    ...
    constructor(arg, offset = 0, length, le) {
        ...
        if (arg === 0) {
            ...
            if (offset + length > arg.byteOffset + arg.byteLength)
                throw Error('Creating view outside of available memory in ArrayBuffer')
            ...
            throw Error('Invalid input argument for BufferView: ' + arg)
        }
    }
    ...
    set(arg, offset, Class = BufferView) {
        ...
        if (!(arg instanceof Uint8Array))
            throw Error(`BufferView.set(): Invalid data argument.`)
